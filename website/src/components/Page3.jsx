...
export default function Page3() {
  return (
    <div className="Third-container">
      <div className="third-left">
        <div>
          ...
          <div className="third-para">
            <p>
              Empower young entrepreneurs to expand <br /> buisness, develop
              essential skills, and network <br /> with industry leaders for
              growth and success.
            </p>
          </div>
      ...
      <img className="third-img values-img" src={third} alt="" />
    </div>
  );
}
